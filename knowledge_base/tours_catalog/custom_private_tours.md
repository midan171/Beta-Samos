# Samos Private & Custom ATV & Hiking Group Tour
...
- **Personalized Meeting Points**: Optional hotel, port, or airport pickup available.

## Full Itinerary
1. **Customized Pickup & Orientation**: Meet at Karlovasi HQ or requested location for private safety briefing and ATV orientation.
2. **Tailored Off-Road Drive**: Drive along pre-agreed scenic tracks tailored to your driving comfort level.
3. **Private Guided Hike**: Explore secluded trails, historic sites, or mountain viewpoints with your private guide.
4. **Custom Refreshment / Dining Stop**: Enjoy curated local snacks, coffee, or tavern lunch.
